    ...
    function hideBiggerPost(){
       ...
       function showPostFormData(){
          ...
          <i onclick="hideEditPostForm()" class="fa-solid fa-xmark" id="post-x-mark"></i>
                ...
                <div class="edit-post-input-wrapper">
                    <label for="p-c-name">Club Name:</label>
                <input class="input-field" type="text" name="clubname" id="p-c-name" placeholder="Club Name" value=${clubNameData.textContent} required readonly>
                 </div>
            <div class="edit-post-input-wrapper">
              <label for="a-cm-name">Club Manager Name:</label>
            <input class="input-field" type="text" name="clubmanager" id="a-cm-name" placeholder="Club Manager Name" value=${clubManageData.textContent} required readonly>
            </div>
