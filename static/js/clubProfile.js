...
<<<<<<< HEAD
            ${clubAchievment1Data.textContent ? `<input type="text" class="club-achievment" name="edit_clubAchievment1" id="edit_clubAchievment1" placeholder="Club's Achievement" value="${clubAchievment1Data.textContent}">` : ''}
            ${clubAchievment2Data.textContent ? `<input type="text" class="club-achievment" name="edit_clubAchievment2" id="edit_clubAchievment2" placeholder="Club's Achievement" value="${clubAchievment2Data.textContent}">` : ''}
            ${clubAchievment3Data.textContent ? `<input type="text" class="club-achievment" name="edit_clubAchievment3" id="edit_clubAchievment3" placeholder="Club's Achievement" value="${clubAchievment3Data.textContent}">` : ''}
            ${clubAchievment4Data.textContent ? `<input type="text" class="club-achievment" name="edit_clubAchievment4" id="edit_clubAchievment4" placeholder="Club's Achievement" value="${clubAchievment4Data.textContent}">` : ''}
            ${clubAchievment5Data.textContent ? `<input type="text" class="club-achievment" name="edit_clubAchievment5" id="edit_clubAchievment5" placeholder="Club's Achievement" value="${clubAchievment5Data.textContent}">` : ''}
=======
...
>>>>>>> 99310b56684d8ec720dd3bf9d4522cba1aea396f
            <div class="area-div">
